...
export default function RootLayout({
    ...
    return (
        <html lang="en">
            ...
            <body>
                <main>
                    <header aria-label="Site Header" className="border-b border-gray-100 w-full">
                        <div
                    ...
                    <div className='flex-1 w-screen max-w-screen-md py-8'>
                        {children}
                    </div>
                        ...
                        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
                            <div className="mx-auto max-w-3xl space-y-6">
                                ...
                                <nav
                                    ...
                                    className="rounded-3xl border-4 border-gray-900 p-6 w-full shadow-2xl"
                                >
